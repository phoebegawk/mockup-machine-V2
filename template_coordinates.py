...
TEMPLATE_COORDINATES = {  
    ...
    "Ballarat CBD (Digital) - 33509-D.png": {
        "split_ratio": [1.0],
        "LHS": [
            (2179, 912),
            (2994, 915),
    ...
    "Port Macquarie (Digital) - 24445-D.png": {
        "split_ratio": [1.0],
        "LHS": [
            (1312, 1114),
            (2171, 1097),
